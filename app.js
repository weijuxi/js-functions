...
console.log('Exercise 1 Result:', maxOfTwoNumbers(7, 9));
...
console.log('Exercise 6 Result:', maxOfThree(5, 10, 12));
...
const createUsername = (firstName,lastName) => {
    ...
    let secondPart = lastName.substring(0, 3);
    
    // Calculate the total length of the first and last name combined
    let totalLength = firstName.length + lastName.length;
    
    // Combine the parts to form the username
    let username = firstPart + secondPart + totalLength;
